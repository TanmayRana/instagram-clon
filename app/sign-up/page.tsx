...
const Signup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      //   toast.error("Error retrieving users. Please try again.");
      //   return;
      // }

      // Check for existing email and username
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      if (usersData.some((user: any) => user.email === formData.email)) {
        toast.error("User with this email already exists");
        return;
      }

      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      if (usersData.some((user: any) => user.username === formData.username)) {
